...
class QWBackendPrivate : public QWWrapObjectPrivate
{
public:
...
{
    return static_cast<QWBackend*>(QWBackendPrivate::map.value(handle));
}
...
QWBackend::QWBackend(wlr_backend *handle, bool isOwner, QObject *parent)
    : QWBackend(*new QWBackendPrivate(handle, isOwner, this), parent)
{
