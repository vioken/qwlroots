...
Q_SIGNALS:
    void pointer_grab_begin();
    void pointer_grab_end();
    void keyboard_grab_begin();
    void keyboard_grab_end();
    void touch_grab_begin();
    void touch_grab_end();
    void request_set_cursor(wlr_seat_pointer_request_set_cursor_event *event);
    void request_set_selection(wlr_seat_request_set_selection_event *event);
    void set_selection();
    void request_set_primary_selection(wlr_seat_request_set_primary_selection_event *event);
    void set_primary_selection();
    void request_start_drag(wlr_seat_request_start_drag_event *event);
    void start_drag(wlr_drag *drag);
    void destroy();
